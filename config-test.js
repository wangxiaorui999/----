...
app.urls = {
    GetMartDailyCN: "http://121.41.80.48:55000/api/Mart/GetMartDailyActivityByPlace?countryCode=CN",
    GetMartDailyTW: "http://121.41.80.48:55000/api/Mart/GetMartDailyActivityByPlace?countryCode=TW",
    GetMartDailyUS: "http://121.41.80.48:55000/api/Mart/GetMartDailyActivityByPlace?countryCode=US",
    GetMartDailyJP: "http://121.41.80.48:55000/api/Mart/GetMartDailyActivityByPlace?countryCode=JP",
    GetMartDailyKR: "http://121.41.80.48:55000/api/Mart/GetMartDailyActivityByPlace?countryCode=KR",
    StudioRecommendsURL: "http://121.41.80.48:60000/Api/ProductInfos/Recommends",//小店推荐地址
    BoutiquesURL: "http://121.41.80.48:60000/api/ShopInfos/Boutiques",//小店精品地址
    StudioContentURL: "http://121.41.80.48:60000/api/ShopInfos?pageSize=5", //全部小店地址
    MySpaceURL: "http://artist-test.momentcam.net/page/MySpace.html?userid=",  //小店头像地址
    ProductDetailURL: "http://artist-test.momentcam.net/page/DetailsPage.html",  //小店图片地址
    GetTotalStoreURL: "http://121.41.80.48:60000/api/ShopInfos/Summary", //小店总数
    GetShopkeeper: "http://121.41.80.48:8101/api/User/GetShopkeeper",//搜索店主
    GetUserProducts: "http://121.41.80.48:8101/api/Product/GetUserProducts",//搜索店铺商品
    GetKeywordsProducts: 'http://121.41.80.48:8101/api/Key/GetKeywords?category=1',//热门店铺商品
    GetKeywordsShopkeeper: 'http://121.41.80.48:8101/api/Key/GetKeywords?category=2',//热门店主
    GetPopularhopURL: "http://121.41.80.48:60000/api/ShopInfos/Boutiques?showType=1", // 人气小店
    //GetPopularhopURL: "//mystudioapi.manboker.com/api/ShopInfos/Boutiques?showType=1", // 人气小店
    GetIndexBanner: "http://121.41.80.48:55000/api/Mart/GetMartDailyActivityByPlace?countryCode=CN", // 轮播图
...
app.appendWebpForImgUrl = function (imgUrl) {
    ...
    return imgUrl + '?x-oss-process=image/format,webp/resize,w_200';
};
...
app.getOptimizedImgUrl = function (imgUrl, maxWidth) {
    ...
    var param = '?x-oss-process=image/format,' + (app.config.isSupportWebp ? 'webp' : 'jpg');
...
(function ($) {
    ...
    var h5Dialog = function () {
        dialogs.push(this);
        var tmpl = '<div style="background-color:black;opacity:.6;padding:40px 60px;border-radius:5px;position:absolute;z-index:9999;transform:translate(-50%,-50%);-webkit-transform:translate(-50%,-50%); left:50%;top:50%;white-space:nowrap;">' +
...
try {
    ...
    app.config.isSupportWebp = canvas.getContext && canvas.getContext('2d') && canvas.toDataURL('image/webp').indexOf('data:image/webp') === 0;
    //这里要先缓存,ios检测不到异常
...
if (app.config.isIos) {
    $('meta[name="viewport"]').attr("content", 'width=1080, minimum-scale=' + scale + ', maximum-scale=' + scale + ',user-scalable=no' + ',target-densitydpi=device-dpi');
} else {
    $('meta[name="viewport"]').attr("content", 'width=1080, minimum-scale=' + scale + ', maximum-scale=' + scale + ',target-densitydpi=device-dpi');
}
